...
public class EducationDaoImpl implements DaoService<Education> {
    ...
    public List<Education> fechAll() throws SQLException, ClassNotFoundException {
        ...
        try(Connection connection = MySQLConnection.createConnection()) {
            String query = "SELECT e.id, e.school, e.start_date, e.end_date, e.present, e.major, e.description, e.personal_id, f.full_name FROM education e INNER JOIN personal f ON e.personal_id = f.id";
